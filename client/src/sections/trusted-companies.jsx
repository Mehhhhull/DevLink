...
export default function TrustedCompanies() {
    return (
        <section className="flex flex-col items-center">
            <SectionTitle title="Built for hackathon teams" description="DevLink helps teams form, align, and compete with AI-created match recommendations, idea scoring, and execution-ready plans." />
                ...
                <div className="flex flex-col items-center md:items-start max-md:text-center">
                    <a href="https://prebuiltui.com" className="group flex items-center gap-2 rounded-full text-sm p-1 pr-3 text-indigo-300 bg-indigo-200/15">
                        ...
                        <p className="flex items-center gap-1">
                            <span>Explore AI team matching </span>
                    ...
                    <h1 className="text-3xl font-medium max-w-xl mt-5 bg-gradient-to-r from-white to-[#b6abff] text-transparent bg-clip-text">Trusted by teams building better hackathon projects.</h1>
                    <p className="text-base text-slate-400 max-w-lg mt-4">
                        DevLink turns unbalanced squads into strong teams, vague ideas into clear roadmaps, and judge feedback into better demos.
                    </p>
